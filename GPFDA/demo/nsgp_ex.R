...
# source("aux_code/nsgp.functions.R")
# source("aux_code/CalcScaleDistMats.R")
# source("aux_code/CalcAnisotropyMat.R")
...
#               zeroNoiseVariance = T,
#               sepcov2D = F)
# hp <- fit$MLEsts # ML estimates of B-spline coefficients
# end NOT RUN  ----------------------------------------------------------------
...
### Plotting a slice of the true and fitted covariance functions
