...
a1 <- gpfr(response=response_train, lReg=scalar_train, 
           ...
           time=tt, rPreIdx=T, concurrent=T)
```
...
```{r, results=F}
b1 <- gpfrpred(a1,TestData=as.matrix(x_new),NewTime=t_new,
               lReg=U_new, fReg=NULL,
...
```{r, results=F}
b2 <- gpfrpred(a1,TestData=as.matrix(x_new),NewTime=t_new,
               lReg=U_new, fReg=NULL,
...
```{r, results=F}
b3 <- gpfrpred(a1,TestData=as.matrix(x_new),NewTime=t_new,
               lReg=U_new, fReg=NULL, gpReg=NULL)
