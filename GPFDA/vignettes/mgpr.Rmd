...
including $m=200$ observations (out of $750$ of the sample) aiming for a faster estimation.
...
it is more interesting to visualise predictions based on very few data points.
